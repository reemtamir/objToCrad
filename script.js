...
function createCard(obj) {
  ...
  <img style="height:130 + "px"" src="${key.flags['png']}" class="card-img-top" alt="${key.name['common']}'s pic">
  <ul class="list-group list-group-flush">
    <li  class="list-group-item fs-3"> Name: ${key.name['common']}</li>
    <li  class="list-group-item fs-4">population: ${key.population}</li>
